...
class ProductPage {
  constructor() {
    ...
    this.collapsibleSections = document.querySelectorAll(
      ".collapsible-section"
    );
  ...
  handleAddToCart() {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        this.addToCartBtn.style.background = "#ff6b35";
      }, 2000);
  ...
  toggleSection(section) {
    ...
    // Close all sections
    this.collapsibleSections.forEach((s) => {
  ...
  handlePaymentMethod(icon) {
    ...
    const method = icon.textContent;
    this.showNotification(`${method} payment method selected`);
  }
